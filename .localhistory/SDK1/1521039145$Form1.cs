...
namespace SDK1
{
    public partial class Form1 : Form
    {
        ...
        private void FillValues()
        {
            ...
            dgvSudok.Rows[0].Cells[5].Value = 5;
            ...
            dgvSudok.Rows[2].Cells[0].Value = 4;
            dgvSudok.Rows[2].Cells[1].Value = 2;
            dgvSudok.Rows[2].Cells[2].Value = 6;
            dgvSudok.Rows[2].Cells[3].Value = 9;
            dgvSudok.Rows[2].Cells[4].Value = 8;
            dgvSudok.Rows[2].Cells[5].Value = 7;
            dgvSudok.Rows[2].Cells[6].Value = 1;
            dgvSudok.Rows[2].Cells[7].Value = 5;
            dgvSudok.Rows[2].Cells[8].Value = 3;
            dgvSudok.Rows[3].Cells[0].Value = 8;
            dgvSudok.Rows[3].Cells[3].Value = 4;
            dgvSudok.Rows[3].Cells[4].Value = 3;
            dgvSudok.Rows[3].Cells[5].Value = 2;
            dgvSudok.Rows[3].Cells[8].Value = 6;
