...
namespace SDK1
{
    public partial class Form1 : Form
    {
        ...
        {
            dgvSudok.Rows[0].Cells[1].Value = 7;
            dgvSudok.Rows[0].Cells[2].Value = 8;
            dgvSudok.Rows[0].Cells[3].Value = 2;
            dgvSudok.Rows[0].Cells[4].Value = 4;
            dgvSudok.Rows[0].Cells[5].Value = 6;
            dgvSudok.Rows[0].Cells[6].Value = 5;
            dgvSudok.Rows[0].Cells[7].Value = 3;

            dgvSudok.Rows[1].Cells[0].Value = 6;
            dgvSudok.Rows[1].Cells[3].Value = 3;
            dgvSudok.Rows[1].Cells[5].Value = 8;
            dgvSudok.Rows[1].Cells[6].Value = 4;
            dgvSudok.Rows[1].Cells[7].Value = 2;
            dgvSudok.Rows[1].Cells[8].Value = 7;

            dgvSudok.Rows[2].Cells[0].Value = 3;
            dgvSudok.Rows[2].Cells[1].Value = 4;
            dgvSudok.Rows[2].Cells[2].Value = 2;
            dgvSudok.Rows[2].Cells[3].Value = 7;
            dgvSudok.Rows[2].Cells[5].Value = 5;
            dgvSudok.Rows[2].Cells[6].Value = 8;
            dgvSudok.Rows[2].Cells[7].Value = 6;

            dgvSudok.Rows[3].Cells[0].Value = 4;
            dgvSudok.Rows[3].Cells[1].Value = 2;
            dgvSudok.Rows[3].Cells[2].Value = 6;
            dgvSudok.Rows[3].Cells[3].Value = 9;
            dgvSudok.Rows[3].Cells[4].Value = 8;
            dgvSudok.Rows[3].Cells[5].Value = 7;
            dgvSudok.Rows[3].Cells[6].Value = 1;
            dgvSudok.Rows[3].Cells[7].Value = 5;
            dgvSudok.Rows[3].Cells[8].Value = 3;

            dgvSudok.Rows[4].Cells[0].Value = 8;
            dgvSudok.Rows[4].Cells[3].Value = 4;
            dgvSudok.Rows[4].Cells[4].Value = 3;
            dgvSudok.Rows[4].Cells[5].Value = 2;
            dgvSudok.Rows[4].Cells[8].Value = 6;

            dgvSudok.Rows[5].Cells[1].Value = 3;
            dgvSudok.Rows[5].Cells[3].Value = 5;
            dgvSudok.Rows[5].Cells[4].Value = 6;
            dgvSudok.Rows[5].Cells[5].Value = 1;
            dgvSudok.Rows[5].Cells[6].Value = 2;
            dgvSudok.Rows[5].Cells[7].Value = 8;
            dgvSudok.Rows[5].Cells[8].Value = 4;

            dgvSudok.Rows[6].Cells[0].Value = 2;
            dgvSudok.Rows[6].Cells[1].Value = 9;
            dgvSudok.Rows[6].Cells[3].Value = 1;
            dgvSudok.Rows[6].Cells[5].Value = 3;
            dgvSudok.Rows[6].Cells[6].Value = 6;
            dgvSudok.Rows[6].Cells[8].Value = 8;

            dgvSudok.Rows[7].Cells[1].Value = 8;
            dgvSudok.Rows[7].Cells[3].Value = 6;
            dgvSudok.Rows[7].Cells[5].Value = 9;
            dgvSudok.Rows[7].Cells[6].Value = 3;
            dgvSudok.Rows[7].Cells[8].Value = 2;

            dgvSudok.Rows[8].Cells[1].Value = 6;
            dgvSudok.Rows[8].Cells[2].Value = 3;
            dgvSudok.Rows[8].Cells[3].Value = 8;
            dgvSudok.Rows[8].Cells[4].Value = 2;
            dgvSudok.Rows[8].Cells[5].Value = 4;
            dgvSudok.Rows[8].Cells[7].Value = 1;
        ...
        private bool CheckCellBox(int[,,] fullArray, int rowsDone)
        {
            ...
            for (int g = 0; g < 3; g++)
            {
                ...
                for (int values = 0; values < 9; values++)
                {
                    ...
                    {
                        string valuefound = (values + 1).ToString();
                        int rowPosition = (g * 3) + (values / 3);
                        int columnPosition = boxRowValue + (values % 3);
                        MethodInvoker methodInvokerChangeValues = delegate ()
                        {
