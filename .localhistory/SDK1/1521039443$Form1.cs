...
namespace SDK1
{
    public partial class Form1 : Form
    {
        ...
        private void FillValues()
        {
            ...
            dgvSudok.Rows[6].Cells[3].Value = 5;
            dgvSudok.Rows[6].Cells[4].Value = 6;
            dgvSudok.Rows[6].Cells[5].Value = 1;
            dgvSudok.Rows[6].Cells[6].Value = 2;
            dgvSudok.Rows[6].Cells[7].Value = 8;
            dgvSudok.Rows[6].Cells[8].Value = 4;
