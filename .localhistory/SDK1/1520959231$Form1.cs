...
namespace SDK1
{
    public partial class Form1 : Form
    {
        ...
        private void DgvSudok_CellValueChanged(object sender, DataGridViewCellEventArgs e)
        {
            ...
            int boxPositionHeight = row / 3;
            int boxPositionWidth = column / 3;
            ...
            for (int i = 0; i < dgvSudok.Rows[row-1].Cells.Count; i++)
            {
                ...
                boxValues[i] = Convert.ToInt32(dgvSudok.Rows[boxPositionHeight + 1 + (i / 3)].Cells[boxPositionWidth + 1 + (i % 3)].Value);
